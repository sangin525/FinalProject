         ...
         <tbody>
            <c:choose>
               ...
               <c:otherwise>
                  ...
                  <tr id="row">
                         <input type="hidden" id="hiddenFlno" value="${fn:escapeXml(item.flno)}">
					    <input type="hidden" id="hiddenTitle" value="${fn:escapeXml(item.title)}">
					    <input type="hidden" class="noticeContent_${status.index +1}" id="hiddenContents" value="${fn:escapeXml(item.contents)}">
					    <input type="hidden" id="hiddenFileName" value="${fn:escapeXml(item.fileName)}">
   ...
   <ul class="pagination">
      <c:choose>
         ...
         <c:otherwise>
            <li class="page-item"><a class="page-link"
               href="/free/adminFree?cpage=${pi.cpage-1}" aria-label="Previous">
      ...
      <c:forEach var="page" begin="${pi.startPage}" end="${pi.endPage}">
         <li class="page-item <c:if test="${pi.cpage eq page}">active</c:if>"><a class="page-link"
            href="/free/adminFree?cpage=${page}">${page}</a></li>
      </c:forEach>
      ...
      <c:choose>
         ...
         <c:otherwise>
            <li class="page-item"><a class="page-link"
               href="/free/adminFree?cpage=${pi.cpage+1}" aria-label="Next"> <span

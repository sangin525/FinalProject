...
<body class="recipeBody">
	...
	<div class="addRecipeContainer">
		<div class="recipeContain">
			<h2 class="addRecipe">레시피 수정</h2>
			<form class="addRecipeForm" action="/recipe/editRecipe.do" method="post" enctype="multipart/form-data" novalidate>
				...
				<div class="cont_box">
					<div id="recipePhotoUpload" class="cont_pic2">
						...
						<input type="hidden" name="rno" id="new_recipe_photo" value="${recipe.rno}"> 
	...
	<div class="recipeBtnContainer">
		<button type="submit" id="enrollBtn" class="enrollBtn">레시피 수정</button>
		<button type="button" id="cancelBtn" class="cancelBtn" onclick="history.back()">레시피 수정 취소</button>
	</div>

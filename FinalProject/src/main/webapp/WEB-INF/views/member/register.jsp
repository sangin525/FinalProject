	...
	<div class="registerContain">
		...
		<div class = "postCodeFind">
			<div class="memberInputbox">
				<input type="email" id="email" onkeyup="validateEmail()" autocomplete="off"><label
			...
			<div class="memberInputbox">
				<input type="password" id="password" onkeyup="validatePassword()" autocomplete="off"> <label
			...
			<div class="memberInputbox">
				<input type="text" id="name" autocomplete="off"> <label
					for="name" class="register_label">이름</label>
			</div>
			<div class = "postCodeFind">
			<div class="memberInputbox">
				<input type="text" id="nickName" autocomplete="off"> <label
			...
			<div class="memberInputbox">
				...
				<input type="text" id="phone" autocomplete="off"> <label
					for="phone" class="register_label">전화번호</label>
			</div>
			<div class="memberInputbox">
				<input type="text" id="birth" autocomplete="off"> <label
					for="birth" class="register_label">생년월일</label>
			</div>
			<div class="memberInputbox">
				<input type="text" id="gender" autocomplete="off"> <label
			...
			<div class="memberInputbox">
				<input type="text" id="detailAddress" autocomplete="off"> <label

...
public class MultiUploadFile {
	...
	public static String uploadMethod(List<MultipartFile> multiFileList, String fileContent, RecipeDTO recipe,
			MemberDTO member, HttpServletRequest request, HttpSession session, String boardName,
...
//			File fileCheck = new File(UPLOAD_PATH);
	...
	public static String goodsUploadMethod(List<MultipartFile> multiFileList, String fileContent, RecipeDTO recipe,
			MemberDTO member, HttpServletRequest request, HttpSession session, String boardName,
			List<RecipeDTO> recipeList) {
//File fileCheck = new File(UPLOAD_PATH);

...
//			System.out.println("입력언어"+r);
	...
	public String scrapRecipe(@RequestParam(value = "rno") int rno, RecipeDTO recipe, HttpSession session,
			Model model) {
...
//		}
			...
			if (!multiFileList.isEmpty()) {
				MultiUploadFile.uploadMethod(multiFileList, null, BOARD_NAME, recipe, member, null, session, BOARD_NAME,
						recipeList, null);
			}
...
//			memberService.plusRecipeCount();
	...
	public String editFormRecipe(@RequestParam(value = "rno") int rno, Model model) {
	...
	public String editRecipe(List<MultipartFile> multiFileList, RecipeDTO recipe, HttpSession session) {
		...
		if (!multiFileList.isEmpty()) {
			...
			if (deleteFiles) {
				MultiUploadFile.uploadMethod(multiFileList, null, BOARD_NAME, recipe, null, null, session, BOARD_NAME,
...
//		}
	...
	public String deleteRecipe(@RequestParam(value = "rno") int rno, RecipeDTO recipe, HttpSession session) {
		recipe.setRno(rno);
		recipe.setMno((int) session.getAttribute("mno"));
	...
	public String comment(@RequestParam(value = "rno") int rno, HttpSession session, RecipeDTO recipe, Model model) {
	...
	public String detailRecipe(@RequestParam(value = "rno") int rno, RecipeDTO recipe, Model model,
...
//		System.out.println(result);
	...
	public String recentRecipeList(RecipeDTO recipe, Model model, HttpSession session) {
	...
	public String searchList(RecipeDTO recipe, Model model) {

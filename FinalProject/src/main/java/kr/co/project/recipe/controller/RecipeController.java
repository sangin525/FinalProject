...
//		}
			...
			if (!multiFileList.isEmpty()) {
				MultiUploadFile.uploadMethod(multiFileList, BOARD_NAME, recipe, member, null, session, BOARD_NAME,
						recipeList);
			}
...
//	}
	...
	public String deleteRecipe(@RequestParam(value = "rno") int rno, HttpSession session) {
